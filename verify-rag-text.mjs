...
async function verifyRAG() {
  console.log('Starting RAG verification with text output...');
    ...
    try {
      ...
      if (response.type === 'response.text.delta') {
        ...
        const verificationResults = {
          ...
          responseTime: 'Real-time response received',
          ragScore: queryContext[0]?.score || 0,
        ...
        ws.close();
        process.exit(verificationResults.contextUsed ? 0 : 1);
      }
    } catch (error) {
